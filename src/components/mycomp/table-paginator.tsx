...
function TablePaginator(props: TablePaginationActionsProps) {
  const { count, page, rowsPerPage,nPages,currentPage,setCurrentPage  } = props;
  /*
    ...
    <div>
      <div className="container mx-auto flex justify-center">
        <ul className="flex">
          ...
          <li>
            <button className="h-10 border border-gray-600 bg-white px-5 text-gray-600 hover:bg-gray-100">
              Next
            </button>
          </li>
          <li>
